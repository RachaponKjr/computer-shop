...
import DeleteRepairInvoiceDialog from './DeleteRepairInvoiceDialog';

const RepairInvoiceTable = ({
  invoices,
  onDownload,
  onNavigate,
  onDelete
  ...
  const InvoiceCard = ({ invoice }) => (
    <div className="bg-white rounded-lg shadow-sm p-4 mb-4">
      ...
      <div className="mb-4">
        ...
        <div className="text-sm text-gray-500 line-clamp-2">{invoice.description}</div>
      </div>
      ...
      <div className="flex justify-end gap-2 border-t pt-3">
        ...
        <DeleteRepairInvoiceDialog 
          invoice={invoice}
          onDelete={onDelete}
          open={deleteDialog.open && deleteDialog.invoice?._id === invoice._id}
          onOpenChange={(isOpen) => 
            isOpen ? handleOpenDelete(invoice) : handleCloseDelete()
          }
        />
      </div>
    </div>
...
export default RepairInvoiceTable;